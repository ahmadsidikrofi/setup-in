            ...
            <div className="grid grid-cols-2 max-sm:grid-cols-1 text-[4vw] max-sm:text-center max-sm:text-[6vw] font-bold px-16 max-sm:py-[5vh] sm:py-[10vh] gap-10 ">
                <div>
                    <div className="flex justify-start max-sm:justify-center gap-4 mb-4 jumbotron-title">
                        <Link href="https://github.com/ahmadsidikrofi/setup-in" target="_blank" rel="noopener noreferrer" className="bg-zinc-200 hover:bg-slate-800 rounded-lg p-2 flex items-center text-sm text-gray-800 hover:text-gray-100 ease-linear transition-all">
