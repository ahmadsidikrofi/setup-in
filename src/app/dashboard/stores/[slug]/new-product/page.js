        ...
        <main>
            ...
            <div className=""> 
                ...
                <div className="border border-opacity-30 border-color-accent2 rounded-lg p-5 lg:mx-8">
                    <h2 className="text-color-accent2 font-bold text-2xl">Add Peripheral</h2>
                    <p className="text-muted-foreground text-sm">
                        Add a your peripheral desk to your store
                    </p>
                    <div className="mt-5">
                        <FormNewProduct storeId={detailData.id} slugStore={detailData.slug}/>
                    </div>
                </div>
            </div>
        </main>
